...
const PostAd = () => {
  ...
  const categories = [
    { value: 'house', label: 'Real Estate', subcategories: ['Apartment', 'House', 'Land', 'Commercial'] },
    { value: 'transport', label: 'Transportation', subcategories: ['Cars', 'Motorcycles', 'Bicycles', 'Parts'] },
    { value: 'market', label: 'Marketplace', subcategories: ['Electronics', 'Furniture', 'Clothing', 'Books', 'Other'] },
    { value: 'health', label: 'Healthcare', subcategories: ['Equipment', 'Supplies', 'Services'] },
    { value: 'jobs', label: 'Jobs', subcategories: ['Full-time', 'Part-time', 'Contract', 'Internship'] },
    { value: 'education', label: 'Education', subcategories: ['Tutoring', 'Courses', 'Books', 'Materials'] },
    { value: 'entertainment', label: 'Entertainment', subcategories: ['Events', 'Tickets', 'Equipment'] }
  ];
                ...
                {formData.discount_percentage && parseFloat(formData.discount_percentage) > 0 && (
                  <div className="bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg p-3">
                    <p className="text-sm font-medium text-green-800 dark:text-green-200">
                      Final Price: KSh {(parseFloat(formData.price || '0') * (1 - parseFloat(formData.discount_percentage || '0') / 100)).toFixed(2)}
                    </p>
                  </div>
                )}
              </CardContent>
